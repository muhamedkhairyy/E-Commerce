import { ICategory, IFormData, IProduct } from "../../type";
...
export const FormList: IFormData[] =[
  { id: 'title', name: 'title', type: 'text', label: 'Title' },
  { id: 'description', name: 'description', type: 'text', label: 'Description' },
  { id: 'imageURL', name: 'imageURL', type: 'text', label: 'ImageURL' },
  { id: 'price', name: 'price', type: 'text', label:' price' },
]
